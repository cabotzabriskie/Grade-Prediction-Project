...
sink("Output Text/Univariate wk4 Logistic Models.txt")
...
write.csv(modL1.2Odds,"Model Fits/Class Wk4 Logistic Fit P2.csv", row.names = T)
...
write.csv(fitLogOdds,"Model Fits/Class and registrar Wk4 Logistic Fit P2.csv", row.names = T)
